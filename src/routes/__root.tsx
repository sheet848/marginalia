...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover rare editions, modern classics, and curated reads at Marginalia, the marketplace for book lovers." },
      { name: "author", content: "Marginalia" },
      { property: "og:title", content: "Marginalia — A Marketplace for Book Lovers" },
      { property: "og:description", content: "Discover rare editions, modern classics, and curated reads." },
